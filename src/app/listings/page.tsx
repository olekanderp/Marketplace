...
import { getMandate, listAssets } from "@/lib/repo";
...
export default async function ListingsPage({
  ...
  const { items, total, page, pageCount } = await listAssets(query, {
    scope: "published",
    mandate,
  });
    ...
    <div className="space-y-6">
      <header className="space-y-1">
        ...
        <p className="text-[15px] text-muted">
          ...
          {mandate && " Ranked against your mandate."}
        </p>
      </header>

      <AssetFilters total={total} />
